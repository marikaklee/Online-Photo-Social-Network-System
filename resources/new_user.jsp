...
<% if (!newUserBean.getEmail().equals("")) {
     if (!newUserBean.getPassword1().equals(newUserBean.getPassword2())) {
       ...
       boolean success = newUserDao.create(newUserBean.getEmail(),
             newUserBean.getPassword1(), newUserBean.getFirst(), newUserBean.getLast(), newUserBean.getGender(), newUserBean.getBirthdate());
       if (success) {
         showForm = false;
       } else {
...
<form action="newuser.jsp" method="post">
  ...
  Date of Birth (Example of format: 1993-02-13) <input type="text" name="birthdate"><br> 
